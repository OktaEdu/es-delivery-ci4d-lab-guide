...
1. Open `AD FS Management` by clicking on the ![AD FS Management](./.tour-resources/adfsmanagementicon.png) icon all the way to the right in the Windows toolbar.
