...
1. In a new tab, navigate to our DNS configuration tool at [https://cloud-flare-tool-e673fb910ddb.herokuapp.com/update/dns](https://cloud-flare-tool-e673fb910ddb.herokuapp.com/update/dns).
...
5.  Switch back to the DNS configuration tool and paste the value you just copied into the **Host** field.

6.  Switch back to your Okta tab and copy the **Value** entry in the **TXT** row (a unique value generated by Okta).
